  ...
  //  # function 3 update file
    ...
    render () {
            return (
              <React.Fragment>
                <div>
                    ...
                    <Modal isOpen={this.state.modalIsOpen} id={this.state.id} title={this.state.title} content={this.state.content} category={this.state.category} >
        ...
        <label htmlFor="category">Category</label>
                    ...
                    <Modal isOpen={this.state.Open} id={this.state.id} file={this.state.fileBefore}>
                      ...
                      <p> Your current uploaded file: {this.state.fileBefore}</p>                
